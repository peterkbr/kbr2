...
public class DBScripts {
    ...
    public static final String[] COLUMNS_BIRALAT = new String[]{COLUMN_BIRALAT_AZONO, COLUMN_BIRALAT_TENAZ, COLUMN_BIRALAT_ORSKO, COLUMN_BIRALAT_BIRDA,
            COLUMN_BIRALAT_BIRTI, COLUMN_BIRALAT_KULAZ, COLUMN_BIRALAT_AKAKO, COLUMN_BIRALAT_FELTOLTETLEN, COLUMN_BIRALAT_EXPORTALT, COLUMN_BIRALAT_KOD01,
    ...
    public static List<String> createDBStrings() {
        ...
        for (int i = 9; i < COLUMNS_BIRALAT.length; i++) {
