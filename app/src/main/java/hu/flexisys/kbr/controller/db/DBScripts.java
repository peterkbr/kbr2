...
public class DBScripts {
    ...
    public static final String COLUMN_BIRALAT_ID = "_id";
    ...
    public static final String COLUMN_BIRALAT_MEGJEGYZES = "MEGJEGYZES";
    ...
    public static final String[] COLUMNS_BIRALAT =
            new String[]{COLUMN_BIRALAT_ID, COLUMN_BIRALAT_AZONO, COLUMN_BIRALAT_TENAZ, COLUMN_BIRALAT_ORSKO, COLUMN_BIRALAT_BIRDA, COLUMN_BIRALAT_BIRTI,
                    COLUMN_BIRALAT_KULAZ, COLUMN_BIRALAT_AKAKO, COLUMN_BIRALAT_FELTOLTETLEN, COLUMN_BIRALAT_EXPORTALT, COLUMN_BIRALAT_LETOLTOTT,
                    COLUMN_BIRALAT_MEGJEGYZES, COLUMN_BIRALAT_KOD01, COLUMN_BIRALAT_ERT01, COLUMN_BIRALAT_KOD02, COLUMN_BIRALAT_ERT02, COLUMN_BIRALAT_KOD03,
                    COLUMN_BIRALAT_ERT03, COLUMN_BIRALAT_KOD04, COLUMN_BIRALAT_ERT04, COLUMN_BIRALAT_KOD05, COLUMN_BIRALAT_ERT05, COLUMN_BIRALAT_KOD06,
                    COLUMN_BIRALAT_ERT06, COLUMN_BIRALAT_KOD07, COLUMN_BIRALAT_ERT07, COLUMN_BIRALAT_KOD08, COLUMN_BIRALAT_ERT08, COLUMN_BIRALAT_KOD09,
                    COLUMN_BIRALAT_ERT09, COLUMN_BIRALAT_KOD10, COLUMN_BIRALAT_ERT10, COLUMN_BIRALAT_KOD11, COLUMN_BIRALAT_ERT11, COLUMN_BIRALAT_KOD12,
                    COLUMN_BIRALAT_ERT12, COLUMN_BIRALAT_KOD13, COLUMN_BIRALAT_ERT13, COLUMN_BIRALAT_KOD14, COLUMN_BIRALAT_ERT14, COLUMN_BIRALAT_KOD15,
                    COLUMN_BIRALAT_ERT15, COLUMN_BIRALAT_KOD16, COLUMN_BIRALAT_ERT16, COLUMN_BIRALAT_KOD17, COLUMN_BIRALAT_ERT17, COLUMN_BIRALAT_KOD18,
                    COLUMN_BIRALAT_ERT18, COLUMN_BIRALAT_KOD19, COLUMN_BIRALAT_ERT19, COLUMN_BIRALAT_KOD20, COLUMN_BIRALAT_ERT20, COLUMN_BIRALAT_KOD21,
                    COLUMN_BIRALAT_ERT21, COLUMN_BIRALAT_KOD22, COLUMN_BIRALAT_ERT22, COLUMN_BIRALAT_KOD23, COLUMN_BIRALAT_ERT23, COLUMN_BIRALAT_KOD24,
                    COLUMN_BIRALAT_ERT24, COLUMN_BIRALAT_KOD25, COLUMN_BIRALAT_ERT25, COLUMN_BIRALAT_KOD26, COLUMN_BIRALAT_ERT26, COLUMN_BIRALAT_KOD27,
                    COLUMN_BIRALAT_ERT27, COLUMN_BIRALAT_KOD28, COLUMN_BIRALAT_ERT28, COLUMN_BIRALAT_KOD29, COLUMN_BIRALAT_ERT29, COLUMN_BIRALAT_KOD30,
    ...
    public static List<String> createDBStrings() {
        ...
        builder.append("CREATE TABLE IF NOT EXISTS ").append(TABLE_EGYED).append(" ( ");
        ...
        builder = new StringBuilder();
        builder.append("CREATE TABLE IF NOT EXISTS ").append(TABLE_BIRALAT).append(" ( ");
        builder.append(COLUMN_BIRALAT_ID).append(" INTEGER PRIMARY KEY AUTOINCREMENT, ");
        ...
        builder.append(COLUMN_BIRALAT_MEGJEGYZES).append(" TEXT ");
        for (int i = 12; i < COLUMNS_BIRALAT.length; i++) {
